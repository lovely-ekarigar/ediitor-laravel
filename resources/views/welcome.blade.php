...
<body class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4">
                <div class="flex flex-col space-y-2 pt-2">
                    <a href="{{ route('welcome') }}" class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-base font-medium transition">
                        Home
                    </a>
                    ...
                    <a href="{{ route('categories.index') }}" class="text-gray-700 hover:text-indigo-600 px-3 py-2 rounded-md text-base font-medium transition">
                        Categories
                    </a>
    ...
    <section class="relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-24">
            ...
            <!-- Decorative Elements -->
            <div class="hidden sm:block absolute top-0 right-0 -mt-12 -mr-12 opacity-10">
                <svg class="w-64 h-64 md:w-96 md:h-96 text-indigo-600" fill="currentColor" viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="40"/>
                </svg>
            </div>
            <div class="hidden sm:block absolute bottom-0 left-0 -mb-12 -ml-12 opacity-10">
                <svg class="w-64 h-64 md:w-96 md:h-96 text-purple-600" fill="currentColor" viewBox="0 0 100 100">
                    <circle cx="50" cy="50" r="40"/>
                </svg>
            </div>
        </div>
    ...
    <footer class="bg-gray-900 text-white py-6 sm:py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p class="text-sm sm:text-base text-gray-400">© 2024 Elite Question Management System. Built with Laravel 11 & Tailwind CSS.</p>
        </div>
    </footer>
