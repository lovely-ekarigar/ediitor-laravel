...
<div class="mb-6 sm:mb-8 lg:mb-8">
    <h1 class="text-2xl sm:text-3xl lg:text-3xl font-bold text-gray-900 mb-2">Categories</h1>
    <p class="text-sm sm:text-base lg:text-base text-gray-600">Browse all question categories</p>
</div>

<!-- Categories Grid -->
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-6">
    @forelse($categories as $category)
        <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition p-4 sm:p-6 lg:p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-2xl sm:text-3xl lg:text-3xl font-bold text-indigo-600">{{ $category->questions_count }}</span>
            </div>
            
            <h3 class="text-lg sm:text-xl lg:text-xl font-semibold text-gray-900 mb-2">{{ $category->name }}</h3>
