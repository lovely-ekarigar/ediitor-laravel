...
<div class="bg-white rounded-xl shadow-md p-4 sm:p-6 lg:p-8 xl:p-10 mb-4 sm:mb-6 lg:mb-8">
    <form action="{{ route('questions.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative">
                <input 
                    ...
                    class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm sm:text-base"
                >
        ...
        <div>
            ...
            <select name="category_id" class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm sm:text-base">
        ...
        <div>
            ...
            <select name="difficulty" class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm sm:text-base">
        ...
        <!-- Submit Button -->
        <div class="md:col-span-4 flex flex-col sm:flex-row justify-end gap-2 sm:gap-0">
            <button type="submit" class="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white px-4 sm:px-6 py-2 rounded-lg text-sm sm:text-base font-medium transition shadow-md hover:shadow-lg">
                Apply Filters
            </button>
            <a href="{{ route('questions.index') }}" class="w-full sm:w-auto text-center sm:ml-3 bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 sm:px-6 py-2 rounded-lg text-sm sm:text-base font-medium transition">
                Clear
            </a>
        </div>
    </form>
