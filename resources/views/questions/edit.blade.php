        ...
        <div class="mb-6">
            ...
            <div id="optionsContainer" class="space-y-3">
                @foreach($question->options as $index => $option)
                    <div class="option-row flex items-start gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200" data-option-index="{{ $index }}">
                        ...
                        <div class="flex-1">
                            ...
                            <div id="editorjs-option-{{ $index }}" class="border border-gray-300 rounded-lg bg-white min-h-[200px] p-3 @error('options.'.$index.'.option_text') border-red-500 @enderror" style="cursor: text;"></div>
